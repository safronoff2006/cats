...
val gh = GitHubSettings(org = "safronoff2006", proj = "catalist", publishOrg = "safronoff2006", license = apache2)

val mainDev =
  Developer("safronoff2006", "@yourhandler_without_@", "yourEmail", new java.net.URL("http://github.com/yourhandler_without_@"))
...
lazy val Catalist = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "catalist"),
    micrositeDocumentationUrl := "/catalist/api/safronoff2006/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "safronoff2006"
  )
